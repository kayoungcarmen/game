...
# Create a new dataset by filtering out the release year from 2007 through 2016

CREATE TABLE vgsales_20072016 AS 
SELECT * FROM vgsales 
WHERE vgs_Year >=2007 AND vgs_Year <=2016;



# Check whether the values in each column are distinct - platform

SELECT DISTINCT vgs_Platform 
FROM vgsales_20072016
ORDER BY vgs_Platform;



# Check whether the values in each column are distinct - genre

SELECT DISTINCT vgs_Genre 
FROM vgsales_20072016
ORDER BY vgs_Genre;



# Check whether the values in each column are distinct - publisher

SELECT DISTINCT vgs_Publisher 
FROM vgsales_20072016
ORDER BY vgs_Publisher;